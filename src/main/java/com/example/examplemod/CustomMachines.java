...
public class CustomMachines extends TieredIOPartMachine implements IDistinctPart, IMachineModifyDrops {

    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(CustomMachines.class,
    ...
    public CustomMachines(IMachineBlockEntity holder, int tier, IO io, Object... args) {
