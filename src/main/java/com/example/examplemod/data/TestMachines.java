...
public class TestMachines extends TieredIOPartMachine implements IDistinctPart, IMachineModifyDrops {

    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(TestMachines.class,
    ...
    public TestMachines(IMachineBlockEntity holder, int tier, IO io, Object... args) {
