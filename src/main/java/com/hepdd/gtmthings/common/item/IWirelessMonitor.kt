    ...
    fun getDisplayText(all: Boolean, displayTextWidth: Int): List<Component> {
        ...
        textListCache.add(
            FormatUtil.formatWithConstantWidth(
                ...
                ).withStyle(ChatFormatting.DARK_AQUA), Component.literal(
        ...
        textListCache.add(
            FormatUtil.formatWithConstantWidth(
                ...
                ).withStyle(ChatFormatting.DARK_GREEN), Component.literal(
        ...
        textListCache.add(
            FormatUtil.formatWithConstantWidth(
                "gtmthings.machine.wireless_energy_monitor.tooltip.now", displayTextWidth, Component.literal(
                    FormatUtil.formatBigDecimalNumberOrSic(avgEnergy)
                ).withStyle(ChatFormatting.DARK_PURPLE), Component.literal(
        ...
        if (compare > 0) {
            textListCache.add(
                Component.translatable(
                    ...
                    if (container.getCapacity() == null) Component.translatable("gtmthings.machine.wireless_energy_monitor.tooltip.time_to_fill")
                    else getTimeToFillDrainText(
        ...
        textListCache.add(
            Component.translatable("gtmthings.machine.wireless_energy_monitor.tooltip.statistics").append(
                ComponentPanelWidget.withButton(
                    if (all) Component.translatable("gtmthings.machine.wireless_energy_monitor.tooltip.all") else Component.translatable(
