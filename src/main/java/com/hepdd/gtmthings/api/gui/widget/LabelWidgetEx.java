...
public class LabelWidgetEx extends Widget implements IConfigurableWidget {
    ...
    public LabelWidgetEx() {
        this(0, 0, "label");
    }

    public LabelWidgetEx(int xPosition, int yPosition, String text) {
        this(xPosition, yPosition, () -> text);
    }

    public LabelWidgetEx(int xPosition, int yPosition, Component component) {
    ...
    public LabelWidgetEx(int xPosition, int yPosition, Supplier<String> text) {
        super(new Position(xPosition, yPosition), new Size(10, 10));
        setDropShadow(true);
        setTextColor(-1);
    ...
    @Deprecated
    public LabelWidgetEx setTextColor(int color) {
        this.color = color;
    ...
    @Deprecated
    public LabelWidgetEx setDropShadow(boolean dropShadow) {
