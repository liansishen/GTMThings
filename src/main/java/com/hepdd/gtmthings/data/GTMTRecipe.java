...
public class GTMTRecipe {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTMThings.id("wireless_energy_receive_cover_uhv"))
                ...
                .inputItems(TagPrefix.cableGtSingle, GTMaterials.Trinium, 2)
                .inputItems(TagPrefix.cableGtSingle, GTMaterials.RedAlloy, 2)
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTMThings.id("wireless_energy_receive_cover_uhv_4a"))
                .inputItems(CustomItems.WIRELESS_ENERGY_RECEIVE_COVER_UHV.asStack(2))
                .inputItems(GTItems.ADVANCED_SMD_INDUCTOR.asStack(64))
                .inputItems(TagPrefix.cableGtQuadruple, GTMaterials.Trinium, 4)
                .inputItems(GTItems.VOLTAGE_COIL_UV.asStack(2))
                .inputItems(TagPrefix.plateDouble, GTMaterials.BatteryAlloy, 2)
                .inputFluids(GTMaterials.SolderingAlloy.getFluid(144))
        ...
        for (int tier : GTValues.tiersBetween(GTValues.LV, GTCEuAPI.isHighTier() ? GTValues.MAX : GTValues.UV)) {
            if (GTMachines.ENERGY_INPUT_HATCH[tier] == null) continue;
        ...
        for (int tier : GTValues.tiersBetween(GTValues.EV, GTCEuAPI.isHighTier() ? GTValues.MAX : GTValues.UV)) {
            // Previously this was checking for a 256A laser hatch for some reason.
            if (tier > GTValues.IV && GTMachines.DUAL_IMPORT_HATCH[tier] != null && CustomMachines.PROGRAMMABLEC_HATCH[tier] != null) {
            ...
            if (GTMachines.ENERGY_INPUT_HATCH_4A[tier] == null) continue;
            ...
            if (GTMachines.ENERGY_INPUT_HATCH_16A[tier] == null) continue;
        ...
        for (int tier : GTValues.tiersBetween(GTValues.IV, GTCEuAPI.isHighTier() ? GTValues.MAX : GTValues.UV)) {
            // bad hack baad hack
            if (GTMachines.LASER_INPUT_HATCH_256[tier] == null) continue;
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTMThings.id("hv_digital_miner"))
                ...
                .save(provider);
        for (int tier : GTValues.tiersBetween(GTValues.LV, GTCEuAPI.isHighTier() ? GTValues.MAX : GTValues.UV)) {
            if (GTMachines.ITEM_IMPORT_BUS[tier] == null) continue;
            if (GTMachines.ITEM_EXPORT_BUS[tier] == null) continue; // add this
            var chest = tier > GTValues.EV ? GTMachines.QUANTUM_CHEST[tier] : GTMachines.SUPER_CHEST[tier];
        ...
        for (int tier : GTValues.tiersBetween(GTValues.LV, GTCEuAPI.isHighTier() ? GTValues.MAX : GTValues.UV)) {
            if (CustomMachines.HUGE_ITEM_IMPORT_BUS[tier] == null) continue;
            var tank = tier > GTValues.EV ? GTMachines.QUANTUM_TANK[tier] : GTMachines.SUPER_TANK[tier];
